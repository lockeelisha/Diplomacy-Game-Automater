...
for i in range(int(game_total)):
    ...
    driver.find_element(By.XPATH, "//input[@name='name']").send_keys(prefix + " "  + game)
    driver.find_element(By.ID, "game_description").send_keys("Part of the Olympus Gunboat Tournament. https://discord.gg/TkYsTs6nJN")
